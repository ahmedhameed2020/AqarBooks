...
grant select on table public.maintenance_categories to anon;
grant select on table public.maintenance_requests to anon;
grant select on table public.maintenance_request_updates to anon;
...
grant execute on function public.assert_maintenance_status_transition(text, text, text) to authenticated, service_role;
